...
def create_topology(args):
    ...
    initial_positions = ['10.0, 10.0, 0.0', '20.0, 10.0, 0.0', '20.0, 0.0, 0.0', '20.0, 20.0, 0.0', '10.0, 20.0, 0.0', '10.0, 0.0, 0.0', '10.0, 0.0, 0.0', '0.0, 10.0, 0.0', '0.0, 20.0, 0.0']
    ...
    #for drone in drones:
    #    drone.p = []
    #    set_position(drone, 10 + 10*i, 10 + 10*i)
    #    i=i+1
    ...
    for drone in drones:
        drone.p = []
        if i == 1:
            set_position(drone, 10, 10)  # Set position for drone 1
        elif i >= 2 and i <= 5:
            set_position(drone, 10 + 10 * (i - 1), 10)  # Set position for drones 2 to 5 in a row
        elif i >= 6 and i <= 9:
            set_position(drone, 10 + 10 * (i - 6), 20)  # Set position for drones 6 to 9 in the next row
        i += 1
...
def set_route(sta, i, finalx, finaly, n=1):
    ...
    finalx = finalx + int(random.uniform(-10,10))
    finaly = finaly + int(random.uniform(-10,10))
